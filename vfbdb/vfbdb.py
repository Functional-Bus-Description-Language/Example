...
class Main:
    def __init__(self, iface):
        self.iface = iface
        self.ID = StaticSingleSingle(iface, 0, (31, 0), 0b011100010110001110000100111101110)
        self.S1 = StatusSingleSingle(iface, 6, (6, 0))
        self.S2 = StatusSingleSingle(iface, 5, (8, 0))
        self.S3 = StatusSingleSingle(iface, 4, (11, 0))
        self.C1 = ConfigSingleSingle(iface, 1, (6, 0))
        self.C2 = ConfigSingleSingle(iface, 2, (8, 0))
        self.C3 = ConfigSingleSingle(iface, 3, (11, 0))
